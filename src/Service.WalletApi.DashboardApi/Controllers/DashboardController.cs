...
using Service.WalletApi.DashboardApi.Controllers.Contracts;
using Service.WalletApi.DashboardApi.Mappers;
using Service.WalletApi.DashboardApi.Services;
using Service.Web;

namespace Service.WalletApi.DashboardApi.Controllers
{
	[Authorize]
	[ApiController]
